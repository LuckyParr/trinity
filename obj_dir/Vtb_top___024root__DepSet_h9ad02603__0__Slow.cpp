...
#endif
            VL_FATAL_MT("tb/tb_top.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->opt = VL_RAND_RESET_I(32);
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->rst_n = VL_RAND_RESET_I(1);
    vlSelf->tb_top__DOT__u_top__DOT__a = VL_RAND_RESET_I(4);
    vlSelf->tb_top__DOT__u_top__DOT__b = VL_RAND_RESET_I(32);
